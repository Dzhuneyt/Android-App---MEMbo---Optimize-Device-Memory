...
public class StatsBlock extends LinearLayout {
	...
	public void init() {
		...
		try {
			Typeface tf = Typeface.createFromAsset(getContext().getAssets(), FontHelper.FONT_COMFORTAA);
			// Apply a typeface globally to the view
			this.setTypeface(tf);
		}catch(RuntimeException exception){
			Log.e(getClass().toString(), "Can not load custom typeface for view", exception);
		}
