...
public class FragmentRunningApps extends DFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setActionBarTitle(R.string.running_processes);

        View v = inflater.inflate(R.layout.fragment_running_processes, null);

        Button bOptimize = (Button)v.findViewById(R.id.bOptimize);
        bOptimize.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onResume() {
        ...
        if (getView() != null) {
            ...
            hideView(getView().findViewById(R.id.llHolder));
            setupListView();
        }
    }
    ...
    class listUpdater extends AsyncTask<Void, Void, Void> {
        ...
        private void updateList() {
            ...
            if (!fragmentVisible || getView() == null)
                return;

            // Remember scrolled position
            final LinearLayout llHolder = (LinearLayout) getView().findViewById(R.id.llHolder);
            showView(llHolder);
